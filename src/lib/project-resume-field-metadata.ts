...
export const projectResumeFieldMetadata: Record<string, FieldMetadata> = {
	...
	requestedTerm: {
		...
		backupSource: "User Input",
		expectedValue: 'Text, e.g., "3 Years + 1 Year Ext"',
		fieldType: "direct",
		dataType: "Text",
		section: "basic-info",
	},
	...
	studioCount: {
		fieldId: "studioCount",
		description: "Number of studio units.",
		primarySource: "Document (Arch Plans)",
		backupSource: "User Input",
	...
	oneBedCount: {
		fieldId: "oneBedCount",
		description: "Number of 1-bedroom units.",
		primarySource: "Document (Arch Plans)",
		backupSource: "User Input",
	...
	twoBedCount: {
		fieldId: "twoBedCount",
		description: "Number of 2-bedroom units.",
		primarySource: "Document (Arch Plans)",
		backupSource: "User Input",
	...
	threeBedCount: {
		...
		description: "Number of 3-bedroom units.",
		primarySource: "Document (Arch Plans)",
		backupSource: "User Input",
