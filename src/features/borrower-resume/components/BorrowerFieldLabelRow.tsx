...
export interface BorrowerFieldLabelRowProps {
	fieldId: string;
	labelText: string;
	required?: boolean;
	hasWarnings: boolean;
...
/**
 * Label row for a borrower resume field: label, required asterisk,
 * help tooltip, optional warnings tooltip, Ask AI button, and lock button.
 */
export function BorrowerFieldLabelRow({
	fieldId,
	labelText,
	required = false,
	hasWarnings,
	...
	onAskAI,
	lockButton,
}: BorrowerFieldLabelRowProps): React.ReactElement {
	return (
		<div className="mb-1">
