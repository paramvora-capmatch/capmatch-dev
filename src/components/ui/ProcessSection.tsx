...
const StepComponent: React.FC<{ step: ProcessStepData; index: number }> = ({
	...
	const TextContent = () => (
		...
		>
			<div className="bg-white/85 backdrop-blur-sm border border-gray-200 rounded-2xl p-8 shadow-lg">
				<div className="mb-5 inline-flex items-center justify-center p-3 rounded-full border-2 w-20 h-20 shadow-lg bg-blue-100 border-blue-400">
					{step.icon}
				</div>
				<h3 className="text-3xl md:text-4xl font-bold mb-5 leading-tight text-gray-900">
					{step.title}
				</h3>
...
export const ProcessSection: React.FC = () => {
	...
	return (
		<div
			ref={sectionRef}
			id="process-section"
			className="min-h-screen overflow-hidden relative flex flex-col justify-center transition-colors duration-300 text-gray-900 mt-16 md:mt-24"
			style={{ backgroundColor: "transparent" }}
		>
			{/* Enhanced title section with better spacing */}
			<motion.div
				className="container mx-auto max-w-7xl px-4 text-center pt-20 pb-12 md:pt-28 md:pb-16"
			...
			>
				<h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-center text-gray-900">
					<span className="text-blue-500">AI</span>-Powered,{" "}
					<span className="text-blue-500">Borrower</span>-Controlled
				</h2>
				<p className="text-lg md:text-xl max-w-3xl mx-auto text-gray-600">
					CapMatch delivers superior lender matching through our
					top-down project acquisition approach, featuring AI-based
					processing and industry-leading lender matching capabilities
					that outperform everything else in the market.
				</p>
			</motion.div>
