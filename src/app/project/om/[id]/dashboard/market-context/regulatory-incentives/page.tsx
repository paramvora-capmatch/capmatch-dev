...
export default function RegulatoryIncentivesPage() {
	...
	useOMPageHeader({
		subtitle:
			"Regulatory considerations, tax incentives, and special programs.",
	});
				...
				<Card className="hover:shadow-lg transition-shadow">
					...
					<CardContent>
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
							...
							{historicTaxCredits != null && (
								<div>
									<p className="text-xs text-gray-500 uppercase tracking-wider mb-2">
										Historic Tax Credits
									</p>
									<p className="text-sm font-semibold text-gray-800">
										{typeof historicTaxCredits === "boolean"
											? historicTaxCredits
												? "Yes"
												: "No"
											: historicTaxCredits}
							...
							{newMarketsCredits != null && (
								<div>
									<p className="text-xs text-gray-500 uppercase tracking-wider mb-2">
										New Markets Credits
									</p>
									<p className="text-sm font-semibold text-gray-800">
										{typeof newMarketsCredits === "boolean"
											? newMarketsCredits
												? "Yes"
												: "No"
											: newMarketsCredits}
