...
def should_include_in_digest(
    ...
    Args:
        ...
        user_preferences: Cached list of user notification preferences
...
def filter_events_by_preferences(
    ...
    Args:
        events: List of domain events to filter
        user_preferences: Cached list of user notification preferences
    ...
    for event in events:
        include = should_include_in_digest(event, user_preferences)
        logger.debug(
