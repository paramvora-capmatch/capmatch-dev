...
CREATE TABLE public.projects (
    ...
    name TEXT NOT NULL,
    -- The borrower entity that owns this project
...
CREATE INDEX idx_projects_owner_entity_id ON public.projects(owner_entity_id);
CREATE INDEX idx_projects_assigned_advisor_id ON public.projects(assigned_advisor_id);

-- Table for borrower resumes, one per borrower entity
CREATE TABLE public.borrower_resumes (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    -- Ensures a 1-to-1 relationship with a borrower entity
